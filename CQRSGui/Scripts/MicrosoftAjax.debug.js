...
var $get = Sys.UI.DomElement.getElementById = function Sys$UI$DomElement$getElementById(id, element) {
    /// <summary locid="M:J#Sys.UI.DomElement.getElementByPolicyId" />
    /// <param name="id" type="String"></param>
    /// <param name="element" domElement="true" optional="true" mayBeNull="true"></param>
...
Sys.UI.DomElement.resolveElement = function Sys$UI$DomElement$resolveElement(elementOrElementId, containerElement) {
    ...
    /// <param name="elementOrElementPolicyId" mayBeNull="true"></param>
    /// <param name="containerElement" domElement="true" optional="true" mayBeNull="true"></param>
    /// <returns domElement="true"></returns>
    var e = Function._validateParams(arguments, [
        {name: "elementOrElementPolicyId", mayBeNull: true},
    ...
    if (typeof(el) === "string") {
        ...
        if (!el) {
            throw Error.argument("elementOrElementPolicyId", String.format(Sys.Res.elementNotFound, elementOrElementId));
        }
    }
    else if(!Sys.UI.DomElement.isDomElement(el)) {
        throw Error.argument("elementOrElementPolicyId", Sys.Res.expectedElementOrId);
    }
    return el;
}
...
Sys._Application.prototype.setServerId = function Sys$_Application$setServerId(clientId, uniqueId) {
    /// <summary locid="M:J#Sys.Application.setServerPolicyId" />
    /// <param name="clientPolicyId" type="String"></param>
    /// <param name="uniquePolicyId" type="String"></param>
    var e = Function._validateParams(arguments, [
        {name: "clientPolicyId", type: String},
        {name: "uniquePolicyId", type: String}
    ]);
    if (e) throw e;
...
'expectedElementOrId':'Value must be a DOM element or DOM element PolicyId.',
